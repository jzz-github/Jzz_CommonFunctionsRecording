//
//  JZZCollectionViewFlowLayout.swift
...
class JZZCollectionViewFlowLayout: UICollectionViewFlowLayout {
    //MARK: - 构造方法
    init(style: JZZBannerStyle) {
        self.style = style
        super.init()
    }
...
// MARK: - Logic Helper
extension JZZCollectionViewFlowLayout {

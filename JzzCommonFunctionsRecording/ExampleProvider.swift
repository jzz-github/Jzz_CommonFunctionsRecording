...
enum ExampleProvider {
    ...
    static func systemMoreStyle() -> UITabBarController {
        ...
        let v4 = FourViewController()
        let v5 = MineViewController()
        let v6 = ThreeViewController()
        let v7 = FourViewController()
        let v8 = MineViewController()
    ...
    static func navigationWithTabbarStyle() -> BaseNavigationController {
        let tabBarController = ExampleProvider.customStyle()
        let navigationController = BaseNavigationController.init(rootViewController: tabBarController)
    ...
    static func customColorStyle() -> BaseNavigationController {
        let tabBarController = ESTabBarController()
        let v1 = HomeViewController()
        let v2 = SecondViewController()
        let v3 = ThreeViewController()
    ...
    static func customBouncesStyle() -> BaseNavigationController {
        let tabBarController = ESTabBarController()
        let v1 = HomeViewController()
        let v2 = SecondViewController()
        let v3 = ThreeViewController()
    ...
    static func customBackgroundColorStyle(implies: Bool) -> BaseNavigationController {
        let tabBarController = ESTabBarController()
    ...
    static func customHighlightableStyle() -> BaseNavigationController {
        let tabBarController = ESTabBarController()
        if let tabBar = tabBarController.tabBar as? ESTabBar {
            tabBar.itemCustomPositioning = .fillIncludeSeparator
        }
    ...
    static func customIrregularityStyle(delegate: UITabBarControllerDelegate?) -> BaseNavigationController {
        let tabBarController = ESTabBarController()
    ...
    static func customTipsStyle(delegate: UITabBarControllerDelegate?) -> BaseNavigationController {
        let tabBarController = ESTabBarController()
        tabBarController.delegate = delegate
        tabBarController.title = "Irregularity"
        tabBarController.tabBar.shadowImage = UIImage(named: "transparent")
    ...
    static func customAnimateRemindStyle(implies: Bool) -> BaseNavigationController {
        let tabBarController = ESTabBarController()
        if let tabBar = tabBarController.tabBar as? ESTabBar {
            tabBar.itemCustomPositioning = .fillIncludeSeparator
        }
    ...
    static func customAnimateRemindStyle2(implies: Bool) -> BaseNavigationController {
        let tabBarController = ESTabBarController()
        if let tabBar = tabBarController.tabBar as? ESTabBar {
            tabBar.itemCustomPositioning = .fillIncludeSeparator
        }
    ...
    static func customAnimateRemindStyle3(implies: Bool) -> BaseNavigationController {
        let tabBarController = ESTabBarController()
        if let tabBar = tabBarController.tabBar as? ESTabBar {
            tabBar.itemCustomPositioning = .fillIncludeSeparator
        }
